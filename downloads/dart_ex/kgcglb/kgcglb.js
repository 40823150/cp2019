...
(function dartProgram() {
  ...
  T = {
    main: function() {
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new T.main_closure(tempInput), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    main_closure: function main_closure(t0) {
      this.tempInput = t0;
    }
  };
  var holders = [C, H, J, P, W, T];
  ...
  T.main_closure.prototype = {
    call$1: function(e) {
      ...
      type = t1[t2];
      number = P.int_parse(J.substring$2$s(t1, 0, len - 2));
      if (type === "g") {
        t1 = " " + H.S(number) + " \u516c\u65a4 =  ";
        if (typeof number !== "number")
          return number.$mul();
        (output && C.LabelElement_methods).setInnerHtml$1(output, t1 + C.JSNumber_methods.toStringAsFixed$1(number * 2.204623, 2) + " \u82f1\u938a");
      } else {
        t1 = output && C.LabelElement_methods;
        if (type === "b") {
          t2 = " " + H.S(number) + " \u82f1\u938a = ";
          if (typeof number !== "number")
            return number.$mul();
          t1.setInnerHtml$1(output, t2 + C.JSNumber_methods.toStringAsFixed$1(number * 0.453592, 2) + " \u516c\u65a4");
        } else
          t1.setInnerHtml$1(output, "\u8acb\u8f38\u5165\u6578\u5b57\u52a0\u4e0a lb \u6216 kg!");
      }
      return;
    },
    $signature: 18
...
//# sourceMappingURL=kgcglb.js.map
