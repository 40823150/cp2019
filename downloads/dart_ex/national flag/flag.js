...
(function dartProgram() {
  ...
  L = {
    main: function() {
      ...
      t2 = J.get$onClick$x(t1.querySelector("#TP"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      ...
      t3 = J.get$onClick$x(t1.querySelector("#PR"));
      t2 = H.getTypeArgumentByIndex(t3, 0);
      ...
      t1 = J.get$onClick$x(t1.querySelector("#GE"));
    ...
    drawJP: function(ctx) {
      var _s4_ = "#fff";
      ctx.clearRect(15, 0, 300, 200);
      ctx.fillStyle = _s4_;
      ctx.clearRect(30, 0, 300, 200);
      ctx.fillStyle = _s4_;
      ...
      ctx.fill();
      ctx.beginPath();
      ctx.arc($.$get$circle_x(), $.$get$circle_y(), 60, 0, 6.283185307179586, true);
      ctx.closePath();
    ...
    drawROC: function(ctx) {
      ...
      for (angle = 0, i = 0; i < 25; ++i) {
        ...
        toX = 75 + Math.cos(angle) * 37.5;
        toY = 50 + Math.sin(angle) * 37.5;
        if (i !== 0)
          ctx.lineTo(toX, toY);
        else
          ctx.moveTo(toX, toY);
      ...
      ctx.fill();
      ctx.beginPath();
      ctx.arc(75, 50, 21.25, 0, 6.283185307179586, true);
      ctx.closePath();
      ctx.fillStyle = "rgb(0, 0, 149)";
      ctx.fill();
      ctx.beginPath();
      ctx.arc(75, 50, 18.75, 0, 6.283185307179586, true);
      ctx.closePath();
      ctx.fillStyle = "#fff";
      ctx.fill();
    },
  ...
  L.main_closure2.prototype = {
    call$1: function(e) {
      ...
      t1.fillStyle = "#f1f2f8";
      t1.fillRect(90, 0, 300, 200);
      t1.fillStyle = "#ec1c24";
      t1.fillRect(189, 0, 300, 200);
      t1.closePath();
      return;
    },
    $signature: 1
  ...
  L.main_closure3.prototype = {
    call$1: function(e) {
      ...
      t1.fillRect(0, 0, 300, 200);
      t1.fillStyle = "#0036a8";
      t1.fillRect(0, 66, 300, 200);
      t1.fillStyle = "#d62718";
      t1.fillRect(0, 132, 300, 200);
      t1.closePath();
      return;
    },
    $signature: 1
