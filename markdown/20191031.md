...
<!--PELICAN_END_SUMMARY-->
打開y曹把launchLeo.py執行
到@path ../下的@edit README.md的網址 https://40823110.github.io/cp2019/content/index.html
再到遠端下的@edit publishconf.py找到DISQUS_SITENAME = "https-改你的學號-github-io-cp2019"
最後再到@path markdown裡按ctrl+i 新增目錄2019下的目錄2019 Fall CP 課程下新增@edit 20191031.md目錄再到老師的教學網站下的倉儲找 ..進去找markdownxu裡的20191030.md複製裡面的內容貼上之後save 起來傳
